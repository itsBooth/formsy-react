...
var Formsy = (function(_React$Component) {
  ...
  function Formsy(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Formsy.__proto__ || Object.getPrototypeOf(Formsy)).call(this, props)
    );
    ...
    _this.mapModel = function(model) {
      ...
      return _formDataToObject2.default.toObj(
    ...
    _this.runValidation = function(component) {
      ...
      var validationResults = _utils2.default.runRules(
        value,
        currentValues,
        component.validations,
        _validationRules2.default
      );

      var requiredResults = _utils2.default.runRules(
        value,
        currentValues,
      ...
      return Promise.all([
        _utils2.default.runRules(value, currentValues, component.validations),
        _utils2.default.runRules(
          value,
          currentValues,
          component.requiredValidations
        )
        ...
        return validateComponent.then(() => {
          ...
          var isRequired = Object.keys(component._requiredValidations).length
            ? !!requiredResults.success.length
            : false;
          var isValid =
            !validationResults.failed.length &&
    ...
    _this.validate = function(component) {
      ...
      _this.runValidation(component).then(validation => {
